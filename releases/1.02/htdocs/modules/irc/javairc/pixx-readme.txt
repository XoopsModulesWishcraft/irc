...
Files
-----
  The following ".$GLOBALS['xoopsDB']->prefix("files")." are part of the Pixx GUI:
    pixx.cab : Pixx GUI for Internet Explorer VM.
    pixx.jar : Pixx GUI for Sun JVM.

Installation
------------
  Upload both ".$GLOBALS['xoopsDB']->prefix("files")." to your PJIRC directory, and add them to the file list in
...
Have a look to http://www.pjirc.com/ for ".$GLOBALS['xoopsDB']->prefix("news")." about PJIRC.
