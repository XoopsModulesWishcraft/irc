...
$modversion['credits'] = "IRCMod is a GNU Flash based IRC Chat Module";
$modversion['author'] = "wishcraft (simon@chronolabs.coop)";
$modversion['help'] = "";
$modversion['license'] = "GPL GNU";
$modversion['official'] = 1;
$modversion['image'] = "images/irc_slogo.png";
...
$cssfiles = XoopsLists::getFileListAsArray(XOOPS_ROOT_PATH.'/modules/ircmod/lightIRC/css/');
...
$modversion['templates'][1]['file'] = 'ircmod_chat.html';
$modversion['templates'][1]['description'] = 'Chat Window Template';
?>